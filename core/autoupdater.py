...
class UpdatableModule():
    ...
    def download_updates(self):
        ...
        resp=urequests.get(path_join(self.url,'vtag'))
        ...
        packresp=urequests.get(path_join(self.url,packfile))
        ...
        with rw_sd:
            ...
            with open(packpath+'.sig','wb') as outf:
                resp=urequests.get(packurl+'.sig')
                if resp.status_code != 200:
